...
from serializers.review_serializer import review_schema, review_list_schema
...
def submit_review():
    ...
    try:
        ...
        validated_data = review_schema.load(request.json)
        print(1)
...
def update_review(review_id):
    ...
    try:
        ...
        updated_review['review_date']=datetime.strptime(updated_review["review_date"], "%Y-%m-%d")
        return jsonify({
